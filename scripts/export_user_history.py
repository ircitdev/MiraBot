"""
Экспорт истории переписки пользователя.
"""
...
sys.path.insert(0, 'd:/DevTools/Database/MIRABOT/mira_bot')
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Использование: python export_user_history.py <telegram_id>")
        sys.exit(1)
