...
- [ ] **Исправить парсинг имени** — извлекать имя из фразы, а не брать всё сообщение
- [ ] **Проверить логи ошибки** — найти причину "что-то пошло не так"
- [ ] **Добавить поле `partner_gender`** — чтобы правильно склонять
...
- [ ] Rate limiting — защита от спама (макс. 1 сообщение в 2 сек)
...
- [ ] Retry logic — повторные попытки при ошибках API Claude/Whisper
